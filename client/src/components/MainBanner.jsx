  ...
  return (
    <div className='relative'>
      ...
      <div className='flex items-center mt-6 font-medium'>
        ...
        <img className='md:hidden transition group-focus:transition-x-1' src={assets.white_arrow_icon} alt="arrow" />
        </Link>
        <Link to={"/products"} className="grop hidden md:flex items-center gap-2 px-9 py-3 cursor-pointer">Explore deals
